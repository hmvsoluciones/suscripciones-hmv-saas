...
describe('Service Tests', () => {
  describe('Producto Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Producto(123, 'AAAAAAA', 'AAAAAAA', false);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a Producto', async () => {
        const returnedFromService = { nombre: 'BBBBBB', descripcion: 'BBBBBB', activo: true, ...elemDefault };
      ...
      it('should partial update a Producto', async () => {
        const patchObject = { descripcion: 'BBBBBB', ...new Producto() };
