...
export default class ProductoService {
  find(id: number): Promise<IProducto> {
  ...
  create(entity: IProducto): Promise<IProducto> {
    return new Promise<IProducto>((resolve, reject) => {
      axios
  ...
  update(entity: IProducto): Promise<IProducto> {
    return new Promise<IProducto>((resolve, reject) => {
      axios
  ...
  partialUpdate(entity: IProducto): Promise<IProducto> {
    return new Promise<IProducto>((resolve, reject) => {
      axios
