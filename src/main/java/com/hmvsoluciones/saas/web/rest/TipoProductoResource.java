...
import com.hmvsoluciones.saas.service.TipoProductoQueryService;
import com.hmvsoluciones.saas.service.TipoProductoService;
...
/**
 * REST controller for managing {@link com.hmvsoluciones.saas.domain.TipoProducto}.
 */
@RestController
...
public class TipoProductoResource {
    ...
    public ResponseEntity<TipoProductoDTO> createTipoProducto(@Valid @RequestBody TipoProductoDTO tipoProductoDTO)
        ...
        return ResponseEntity.created(new URI("/api/tipo-productos/" + tipoProductoDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, tipoProductoDTO.getId().toString()))
