...
/**
 * Criteria class for the {@link com.hmvsoluciones.saas.domain.TipoProducto} entity. This class is used
 * in {@link com.hmvsoluciones.saas.web.rest.TipoProductoResource} to receive all the possible filtering options from
...
public class TipoProductoCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, nombre, productoId, distinct);
    }
